...
Add with `dep ensure -add github.com/gatsbyz/termui`. With Dep, `/v3` should *not* be included in the import statements.
...
import (
	...
	ui "github.com/gatsbyz/termui/v3"
	"github.com/gatsbyz/termui/v3/widgets"
)
...
- [wiki](https://github.com/gatsbyz/termui/wiki)
